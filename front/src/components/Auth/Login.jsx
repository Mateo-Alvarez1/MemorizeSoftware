...
export const Login = () => {
  ...
  return (
    <div
      className="bg-pattern  pb-10 lg:pb-0 overflow-x-hidden bg-gradient-to-br from-zinc-800 to-zinc-900 h-screen flex flex-col lg:flex-row lg:justify-between justify-evenly items-center 2xl:px-52 px-28 font-pp"
    >
      <div className='pt-10 w-screen lg:w-6/12 flex flex-col justify-around h-max pb-10 lg:pb-0'>
